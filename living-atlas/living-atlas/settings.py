"""
Django settings for living-atlas project.
...
ROOT_URLCONF = 'living-atlas.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'living-atlas/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'living-atlas.wsgi.application'
